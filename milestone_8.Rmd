...
nyc_shapes_full <- nyc_shapes %>%
  full_join(median_ppn_data, by = c("neighbourhood"))
...
## Questions for OH
- selecting certain stuff based on input...
- where to put my actual code?
    - in the app.R, in an Rmd, in a prep.R file?
    

## Other notes
- make sure to remeber 3 pg pdf write up to be included in directory
- and video - w/ link in write up
